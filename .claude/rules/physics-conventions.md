...
- When modifying simulation code, always validate against known analytical solutions
- Preserve the agent team structure defined in CLAUDE.md (Theorist, Simulator, Critic, Historian)
